...
>(({ children, className, ...props }, ref) => (
  ...
  >
    {children}
    <Icon asChild>
      <CaretSortIcon className="stroke-white-1000 h-4 w-4 opacity-50" />
    </Icon>
  </Trigger>
));
